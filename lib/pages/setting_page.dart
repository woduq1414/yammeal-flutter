...
import 'package:meal_flutter/common/widgets/setting_tile.dart';
import 'package:provider/provider.dart';
import 'package:yaml/yaml.dart';

import 'package:meal_flutter/common/ip.dart';
import 'find_all_favorite_page.dart';
import 'package:meal_flutter/common/firebase.dart';
import 'first_page.dart';
import 'login_page.dart';

// import 'package:meal_flutter/common/set_allergy_page.dart'kage:webview_flutter/webview_flutter.dart';
          ...
          Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SettingTile(
                    title: "알림 켜기",
                    description: "푸쉬 알림을 받아보세요",
                    isUseRightButton: false,
                    rightSwitchValue: mealStatus.isReceivePush,
          ...
          Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SettingTile(
                      title: "급식 메뉴 앱에 저장",
                      description: "데이터 소모를 줄일 수 있어요",
                      isUseRightButton: false,
                      rightSwitchValue: mealStatus.isSaveMenuStorage == "true" ? true : false,
                      rightSwitchOnChanged: (value) {
                        mealStatus.setIsSaveMenuStorage(value ? "true" : "false");
                        print(mealStatus.isSaveMenuStorage);
                      }),
